...
public record ProjectsProperties(ScannerProperties scanner,
    ...
    public record ProviderProperties(GithubProperties github) {
        public record GithubProperties(@NotBlank(message = "Github API URL should not be empty.") @URL(message = "Github API URL should have the correct format.") String url,
                                       String token,
